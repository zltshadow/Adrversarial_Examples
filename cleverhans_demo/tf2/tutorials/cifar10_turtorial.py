...
from cleverhans_demo.tf2.public.attacks import projected_gradient_descent, fast_gradient_method
...
def ld_cifar10():
    ...
    dataset, info = tfds.load("cifar10", data_dir="../../../data", with_info=True, as_supervised=True)
